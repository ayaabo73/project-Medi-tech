				...
				<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
					<div class="row wd-100p mx-auto text-center">
						<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
							<img src="{{URL::asset('dashboard/img/media/signin.jpg')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
						</div>
					</div>
				</div>
				<!-- The content half -->
										...
										<div class="card-sigin">
											<div class="main-signup-header">
												...
												<div class="form-group">
													<label for="exampleFormControlselet1">select the entry method</lable>
													<select class="form-control" id="sectionchooser">
													<option value="">choose from the list</option>
														<option value="user">log in as apatient</option>
														<option value="admin">log in as admin</option>
														<option value="doctor">log in as doctor</option>
                                                          </select>
                                                         </div>
												...
												<form method="POST" action="{{ route('login.user') }}">
													...
													</div><button type="submit" class="btn btn-main-primary btn-block">Log In</button>
